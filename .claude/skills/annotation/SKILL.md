---
name: annotation
description: Auto-label data using Claude API (zero-shot), generate annotation spec, check quality with Cohen's kappa, export to LabelStudio, flag low-confidence examples for HITL review.
---
...
## Доступные скрипты
- `agents/annotation_agent.py` — агент (скиллы: auto_label, generate_spec, check_quality, export_to_labelstudio)
